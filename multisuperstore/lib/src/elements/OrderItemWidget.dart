              ...
              Container(
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Column(
                      children: <Widget>[
                        Text('${S.of(context).order_id}: #${widget.orderdetails.sale_code}'),
                        Text(
                    ...
                    trailing: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Text('${Helper.pricePrint(widget.orderdetails.grand_total)}', style: Theme.of(context).textTheme.headline4),
                        Text(
                          '${widget.orderdetails.payment_type}',
                          style: Theme.of(context).textTheme.caption,
                        )
                      ],
                    ),
