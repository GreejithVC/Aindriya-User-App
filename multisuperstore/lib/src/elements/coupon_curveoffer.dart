                    ...
                    child: Container(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          ...
                          SizedBox(height: 10),
                          Text('FREE DISH', style: (TextStyle(color: Colors.blue))),
                          Text('BUY 2', style: Theme.of(context).textTheme.headline1.merge(TextStyle(color: Colors.blue))),
                          Text('GET 1 FREE', style: Theme.of(context).textTheme.headline1.merge(TextStyle(color: Colors.blue)))
                        ])),
                      ),
                    ),
                  ),
                ...
                child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Container(
                              child: Text('100 + order delivered from recently barbequeen restaurant',
