...
class RestaurantProductBox extends StatefulWidget {
   RestaurantProductBox({Key key,this.popperShow, this.choice, this.con, this.shopId, this.shopName, this.subtitle, this.km, this.shopTypeID, this.latitude, this.longitude, this.callback, this.focusId}) : super(key: key);
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    width: 30,
                                                    child: IconButton(
                                                        onPressed: () {}, icon: Icon(Icons.add), iconSize: 18, color: Theme
                                                        .of(context)
                                                        .primaryColorLight),
                                                  )
                                                ],
                                      ...
                                      child: Padding(
                                        ...
                                        child: Wrap(alignment: WrapAlignment.spaceBetween, children: [
                                          InkWell(
                                            ...
                                            child: Icon(Icons.remove_circle,  color: Theme
                                                .of(context)
                                                .accentColor,size:27),
                                          ...
                                          InkWell(
                                            ...
                                            child: Icon(Icons.add_circle,color: Theme
                                                .of(context)
                                                .accentColor,size:27),
                                ...
                                widget.choice.variant.length>1?Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child:Text('Customizable',style: Theme.of(context).textTheme.caption,textAlign: TextAlign.end,),
                                    ),
