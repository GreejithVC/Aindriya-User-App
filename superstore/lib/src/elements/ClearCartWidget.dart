                  ...
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {},
                              child:Text('Clear cart?',style:Theme.of(context).textTheme.headline1),
                            ),


                            SizedBox(height: 5,),
                            Text('Your cart contains items from all New Shop. Do you want to clear the cart and raise the new order',
