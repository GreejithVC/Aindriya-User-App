    ...
    return Scaffold(
      ...
      children: [
        ...
        FlatButton(
          ...
          shape: Border.all(width: 2.0, color: Theme.of(context).accentColor),
          padding: EdgeInsets.all(15),
          child: Text(
            'GO TO HOME',
            style: Theme.of(context).textTheme.subtitle2.merge(TextStyle(color: Theme.of(context).accentColor, fontWeight: FontWeight.w600)),
          ),
        )
      ],
    )));
