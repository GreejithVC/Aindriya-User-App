              ...
              Container(
                ...
                child: GFAccordion(
                  ...
                  expandedIcon: Container(
                      child: Row(
                        children: [
                          Text('PLAY', style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.w900)),
                          SizedBox(width: 5),
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                            'LIVE',
                                            style: TextStyle(fontSize: 7, color: Theme.of(context).scaffoldBackgroundColor),
                                          ))),
                                ],
                              ),
                              Expanded(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CircularCountDownTimer(
                          ...
                          textStyle: Theme.of(context).textTheme.bodyText1.merge(TextStyle(color:Colors.green)),
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text('\$ 129.00', style: Theme.of(context).textTheme.subtitle2),
                      ],
                    ),
                    SizedBox(height: 10),
                    Row(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text('Add tip', style: TextStyle(color: Colors.orange, fontWeight: FontWeight.w600)),
                                ],
                              ),
                              SizedBox(height: 10),
                              Row(
