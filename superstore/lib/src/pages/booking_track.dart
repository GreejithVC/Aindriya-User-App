          ...
          Container(
            ...
            child: Column(children: [
              ...
              Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.vertical(top: Radius.circular(40.0)), color: Colors.white),
                  child: Column(
                    children: [
                      SizedBox(height: 5),
                      Padding(
                                ...
                                style: Theme.of(context).textTheme.subtitle2,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        _orderTrack.status,
                                        style: TextStyle(color: Theme.of(context).accentColor, fontSize: 14, fontWeight: FontWeight.w700),
                                      ),
                                      /*  GestureDetector(
                              onTap: () {
