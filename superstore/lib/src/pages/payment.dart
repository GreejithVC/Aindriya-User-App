...
import 'package:superstore/src/pages/paypal_payment.dart';
import 'package:superstore/src/pages/stripe_payment.dart';
import 'package:superstore/src/pages/uip_india.dart';
...
class _PaymentPageState extends StateMVC<PaymentPage> {
  ...
  List<bool> paymentSelect = List(7);
  int selectedRadio;
  int checkedItem = 0;

  @override
  void initState() {
    print('flutterwave${setting.value.flutterWave}');
    super.initState();
    selectedRadio = 0;
    _razorpay = Razorpay();
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text('Delivery fee', style: Theme.of(context).textTheme.subtitle2),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text('${Helper.pricePrint(currentCheckout.value.discount)}', style: Theme.of(context).textTheme.subtitle2)
                              ],
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
