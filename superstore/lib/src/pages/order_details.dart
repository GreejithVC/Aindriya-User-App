                                      ...
                                      return Column(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            Expanded(
                                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                Text(_con.invoiceDetailsData.addressUser.id, style: Theme.of(context).textTheme.bodyText1),
                                                Text(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child:Padding(
                                              ...
                                              child: Text(
                                                'Order delivered on october 08.30 PM by haribabu',
                                                style: Theme.of(context).textTheme.bodyText2,
                                                textAlign: TextAlign.left,
                                              ),
                                            ),
                                    ...
                                    child:Column(
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child:Text('Item total',style: Theme.of(context).textTheme.subtitle2,),
                                            ),
                                            SizedBox(width:10),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child:Text('Delivery partner fee',style: Theme.of(context).textTheme.subtitle2,),
                                            ),
                                            SizedBox(width:10),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child:Text('Delivery partner tips',style: Theme.of(context).textTheme.subtitle2,),
                                            ),
                                            SizedBox(width:10),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width:10),
                                            Text('Bill total ${Helper.pricePrint(_con.invoiceDetailsData.payment.grand_total)}',style: Theme.of(context).textTheme.subtitle2.merge(TextStyle(fontWeight: FontWeight.w600)),),
                                          ],
                                        ),
