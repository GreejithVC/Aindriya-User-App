...
import 'package:superstore/src/models/order_details.dart';
                        ...
                        Column(children: [
                         ...
                         Padding(
                           ...
                           child:Row(
                               mainAxisAlignment: MainAxisAlignment.center,
                               children:[
                                 Text('What did the restaurant impress you with?',
                                  ...
                                  InkWell(
                                    ...
                                    child: Column(
                                      children:[
                                        ...
                                        SizedBox(height:10),
                                        Text('Taste',style:Theme.of(context).textTheme.bodyText1)
                                      ]
                                    ),
                                  ),
                                  InkWell(
                                    ...
                                    child: Column(
                                        children:[
                                          ...
                                          SizedBox(height:10),
                                          Text('Packaging',style:Theme.of(context).textTheme.bodyText1)
                                        ]
                                    ),
                                  ),
                                    ...
                                    child: Column(
                                        children:[
                                          ...
                                          SizedBox(height:10),
                                          Text('Portion',style:Theme.of(context).textTheme.bodyText1)
                                        ]
                                    ),
                                  ),
                                ]
                          ...
                          Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Container(
                                    ...
                                    child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: 'Tell us what you liked most',
                                ...
                                Text('Your word make Grocery a better place. You are the influence!',
