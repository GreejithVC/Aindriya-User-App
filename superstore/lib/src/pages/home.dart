      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          loader
            ...
            child: RefreshProgressIndicator(),
              ...
              : ShoppingCartButtonWidget(iconColor: Theme.of(context).hintColor, labelColor: Theme.of(context).splashColor),
        ],
        ...
        title: GestureDetector(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(S.of(context).delivery_location, style: Theme.of(context).textTheme.headline1),
              currentUser.value.latitude== null || currentUser.value.longitude == null
                  ? Text(S.of(context).select_your_address, style: Theme.of(context).textTheme.caption)
                  : Text(currentUser.value.selected_address, style: Theme.of(context).textTheme.caption.merge(TextStyle(color:  Theme.of(context).backgroundColor))),
            ])),
      ),
      body: SafeArea(
              child: Padding(
                    ...
                    Expanded(
                        child:ListView(
                            children:[
                              ...
                              SizedBox(height: 15),
                            setting.value.noticeboard!=''?Padding(
