...
import 'package:superstore/src/models/driver_rating.dart';
import 'package:superstore/src/models/payment.dart';
        ...
        StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              return snapshot.data.docs[0]['status']=='Placed' && timerLimit==false?Container(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child:  CachedNetworkImage(
                          ...
                          imageUrl: "${GlobalConfiguration().getString('api_base_url')}/uploads/vendor_image/vendor_${snapshot.data.docs[0]['shopId']}.png",
                  ...
                  )):snapshot.data.docs[0]['status']=='Shipped'?Container(
                  padding: EdgeInsets.only(left: 18, right: 18, bottom: 18),
                  color: Theme
                      .of(context)
                      .primaryColor,
                    ...
                    children: [
                      ...
                      Badge(
                        ...
                        child: Padding(
                          ...
                          child:  CachedNetworkImage(
                            // ignore: deprecated_member_use
                            imageUrl: "${GlobalConfiguration().getString('api_base_url')}/uploads/driver_image/driver_${snapshot.data.docs[0]['driverId']}.png",
                            placeholder: (context, url) => new CircularProgressIndicator(),
                            errorWidget: (context, url, error) => new Icon(Icons.error),
                            width: 50,
                            height: 50,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Text('Item total', style: Theme.of(context).textTheme.subtitle2),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text('Delivery Tip', style: Theme.of(context).textTheme.subtitle2),
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                      Text('Item',style:TextStyle(color:Theme.of(context).primaryColorLight.withOpacity(0.6))),
                      SizedBox(height: 6),
                      _info == null
                          ? Text('--',
                              style: Theme.of(context)
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      Text('Booking Id: $orderID', style: Theme.of(context).textTheme.subtitle1),
                      SizedBox(height: 10),
